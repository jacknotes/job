...
systemctl restart salt-syndic   --重启服务,这个时候192.168.56.12变成syndic了
#top master for node1
vim /etc/salt/master：
order_masters: True  --开启最高级Master，也就是top master
systemctl restart salt-master  --这个时候sydic master就成了top master for node1的minion了
