...
PROJECT_PREPRO_CREATE_SHELL='/root/k8s/argocd/shell/copyenv-prepro.sh'
PROJECT_TEST_CREATE_SHELL='/root/k8s/argocd/shell/copyenv-test.sh'
...
case $1 in
	replace)
		...
		apply_rollout
		echo "[INFO] STEP 2"
		${PROJECT_PREPRO_CREATE_SHELL} prepro
		echo "[INFO] STEP 3"
		${PROJECT_TEST_CREATE_SHELL} replace $2 $3 $4 $5
		;;
    	*)    
