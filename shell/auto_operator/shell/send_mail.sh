...
SCHTASKS_LIST="/windows/192.168.13.190/schtasks.log /windows/192.168.13.182/sync.log /windows/172.168.2.186/sync.log /windows/192.168.13.24/sync.log /windows/172.168.2.10/video.log /tmp/linux_hosts_task.log"
