...
class Groups(object):
	...
	def get_target(self):
		...
		print(str(datetime.now()), '[INFO] Total groups: %d' % len(target_groups))
	...
	def get(self):
		...
		print(str(datetime.now()), '[INFO] Total groups: %d' % len(groups))
		return groups
	...
	def inserts(self, groups):
		...
		print(str(datetime.now()), '[INFO] Create new group: %d' % len(new_groups))
