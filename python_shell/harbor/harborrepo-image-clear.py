...
class Login(object):
    ...
    def loginStation(self):
        ...
        '''同版本harbor，需要更改Cookie和X-Xsrftoken的值，可用fiddler进行抓巴复制过来使用'''
        self.header = {
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36",
            "Cookie": "_xsrf=R2FEQlVpZm80TjUzcDd5UHV6cFNGYXJUSm90VjRwcms=|1645149662788093445|ad5a35c9ef85315bfd441025aea3661eaeb74056; " + session_id, 
            "X-Xsrftoken": "GaDBUifo4N53p7yPuzpSFarTJotV4prk"
        }
        data = {
...
if __name__ == "__main__":
    harbor_domain = "harborrepo.hs.com" 
    username='0799'
