1.×¼±¸×öRAIDµÄ´ÅÅÌ£¬¶Ô´ÅÅÌ½øÐÐLVM·ÖÇø£¨ÔÚLinuxÏµÍ³ÖÐ£¬ÀýÈçCentOS,ÓÃfdisk /dev/sdaÃüÁî½øÈë£¬ÐÂ½¨Ò»¸ö·ÖÇø²¢Ö¸¶¨´óÐ¡£¬
È»ºó°´t°Ñ·ÖÇø¸ñÊ½ÓÉ83¸Ä³ÉLVMµÄ¸ñÊ½8e£¬×îºó°´w±£´æ²¢ÍË³ö£¬ÍË³öºóÓÃÃüÁîpartprobe»òÖØÆôÊ¹·ÖÇøÁ¢¼´ÉúÐ§£©
2.·ÖÇø½¨Á¢ºÃºó£¬¾ÍÒªÐÂ½¨pvÁË£¬ÓÃpvcreate /dev/sda7;ÓÉÓÚÒÑ¾­ÓÐLVM·ÖÇøÁË£¬ËùÒÔ¾Í²»ÓÃvgcreateÐÂ½¨ÁË£¬ÒªÓÃvgextendÌí¼Óµ½ÏÖÓÐ
µÄvgÖÐ£¬Ê¹ÓÃpvdisplay,vgdisplay²é¿´pv,vg×´Ì¬£¬ÒªÏë×îºó³É¹¦Ìí¼Óµ½LVM,ÔòÒª×îºóÌí¼Óµ½lv,Ê¹ÓÃlvresize -L +12.58G /dev/myvg/mylv
À´Ìí¼Ó12.58GÈÝÁ¿µ½ÏÖÓÐµÄmylvÖÐ£¬×îºóÊ¹ÓÃresize2fsÀ´À©Õ¹ÎÄ¼þÏµÍ³
3.°²×°samba,samba-client,samba-commonÈý¸öÈí¼þ£¬²¢ÉèÖÃ¿ªÆô×Ô¶¯Æô¶¯smb,nmb·þÎñ£¬chkconfig --level 35 smb on; 
chkconfig --level 35 nmb on;È»ºóÊ¹ÓÃ½Å±¾ÉèÖÃlinuxÕÊ»§ºÍsmbÕÊ»§£¬Ê×ÏÈ´´½¨ÐèÒªµÄÈº×é£¬Ê¹ÓÃsys-groups.sh¿É´´½¨£¬sys-groupsdel.sh
¿ÉÉ¾³ýÈº×é£¬ÉèÖÃlinuxÕÊ»§Ê±²»Òª´´½¨¼ÒÄ¿Â¼£¬´´½¨ÃÜÂëÊ±Ê¹ÓÃmkpassword´´½¨Ëæ»úÃÜÂë£¬ÕâÀïÊ¹ÓÃ½Å±¾sys-users.sh¿ÉÒÔ×Ô¶¯´´½¨£¬
Òà¿ÉÊ¹ÓÃsys-usersdel.sh×Ô¶¯É¾³ýlinuxÕÊ»§ºÍsmbÕÊ»§£¬Ê×ÏÈµÃ´´½¨ÓÃ»§ÐÅÏ¢ÔÚsys-usersinfoÀïÃæ¡£
4.±à¼­smbÅäÖÃÎÄ¼þ/etc/samba/smb.cnfÎÄ¼þ£¬ÉèÖÃ
[global] 
	...
	load printers = no
[ÐÅÏ¢²¿]			#¹²ÏíÃû³Æ
        comment = Information	#ÃèÊöÐÅÏ¢
        path = /Share/Info	#ÕæÊµÄ¿Â¼Â·¾¶
        browseable = yes
        writable = yes
        valid users = @Info	#ÓÐÐ§Èº×é
        create mode = 0664
        directory mode = 0775

²¢ÒÀÀýÐÅÏ¢²¿ÉèÖÃ¸÷²¿ÃÅÎÄ¼þ¼Ð£¬ÉèÖÃÌØ¶¨µÄ²¿ÃÅÈº×é¿É¶ÁÐ´£¬ÐÂ½¨ÎÄµµÄ¬ÈÏÈ¨ÏÞ£¬ÐÂ½¨Ä¿Â¼Ä¬ÈÏÈ¨ÏÞ¡£
5.Ê¹ÓÃtestparmÀ´²âÊÔÅäÖÃÎÄ¼þÊÇ·ñÕýÈ·£¬¿ÉÒÔÅÅ½â£¬Òà¿ÉÊ¹ÓÃtestparm -vÀ´ÏêÏ¸²âÊÔ£¬»¹Òª¶Ô¹²ÏíµÄÄ¿Â¼½øÐÐsetfaclÀ´ÉèÖÃ¸úsmb.cnf
ÎÄ¼þÖÐÒ»ÑùµÄÈ¨ÏÞ£¬ÕâÑù²ÅÄÜÊ¹smb·þÎñÈ¨ÏÞÉúÐ§£¬·ñÔò»áÔì³ÉÎÞ·¨Ð´Èë£¬Íêºó³ÉÓÃ»§¿ÉÒÔÊ¹ÓÃ\\IPµÄ·½Ê½À´·ÃÎÊsmb·þÎñÆ÷ÁË£¬
¶øsmb·þÎñÆ÷¿ÉÒÔÊ¹ÓÃsmbstatusÀ´¹Û²ì¿Í»§¶ËÇé¿ö¡£

×¢Òâ£ºÊ¹ÓÃsmbpasswordÀ´¸ü¸ÄsmbÕÊ»§ÃÜÂë£¬Ê¹ÓÃpdbedit -a user --Ôö¼Ó¡¢pdbedit -x user --É¾³ý
